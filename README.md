...
|`createGitHubComments`|no|"false"|This flag used when you want to see violations as comments with the following format: `{priorityIcon} ({priority}) - {fileName} (Line:{startLine})`|
