...
const processSarifReport = function (report) {
    ...
    results.forEach(violation => {
        ...
        violation.locations.forEach(location => {
            ...
            core.debug(` ${annotation.file}:${annotation.startLine}:${rules[violation.ruleIndex].id}:${violation.message.text} (Priority: ${rules[violation.ruleIndex].properties.priority})`);
